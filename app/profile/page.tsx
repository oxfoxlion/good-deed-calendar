...
export default function ProfilePage() {
  ...
  return (
    <DashboardShell
      ...
      title="個人介面"
      description="登入後可查看個人資料與後續的個人紀錄。未登入時可在這裡註冊或登入。"
    >
      {isLoading ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="mt-0.5 flex h-4 w-4 items-center justify-center rounded-full sm:mt-1 sm:h-5 sm:w-5">
                        {hasEntry ? <Check className="size-3.5 text-emerald-600 dark:text-emerald-300 sm:size-4" /> : null}
                      </span>
                    </button>
                  );
                })}
